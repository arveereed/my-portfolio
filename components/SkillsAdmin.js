...
export default function SkillsAdmin() {
  ...
  const handleEditSkill = async (index) => {
    ...
    if (
      skills.some(
        (skill, i) =>
          i !== index && skill.toLowerCase() === editValue.trim().toLowerCase(),
      )
    ) {
      Swal.fire({
        icon: "error",
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-white">Skills Admin</h1>
          ...
          {skills.length > 0 && (
            <div className="mt-6 p-4 bg-blue-900 bg-opacity-50 rounded-lg border border-blue-700">
              ...
              <ul className="text-blue-200 text-sm space-y-1">
                <li>
                  • Use &quot;Bulk Add&quot; to quickly add multiple skills at
                  once
                </li>
                <li>
                  • Skills are automatically sorted and displayed in your
                  portfolio
                </li>
